...
The owner accepted Batch B, authorized Batch C, accepted the Batch D review,
and promoted the completed local baseline. Do not begin Attention integration,
connector, real-data, push, merge, tag, release, or deployment work without
