...
Status: `IP-029 BATCH B2 ACCEPTED — BATCH C1 AUTHORIZATION REQUIRED`
...
| IP-029 | Phase 3 incremental execution evidence, canonical Release/Milestone/Dependency facts, read-only review, and automatic derived Attention | B2 accepted; C1 requires a separate authorization | `implementation-packs/IP-029_PHASE_3_EXECUTION_AND_MILESTONE_FOUNDATION.md` | Not created; required in Batch D |
...
4. Decide whether to authorize bounded IP-029 Batch C1 implementation or
   require a C1 design revision. Do not begin C2/D or Phase 4, use a live
   connector or real data, release, push, merge, or tag work under the current
   gate.
