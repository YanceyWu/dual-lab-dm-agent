...
Status: `IP-029 BATCH C1 ACCEPTED — BATCH C2 AUTHORIZATION REQUIRED`
...
| IP-029 | Phase 3 incremental execution evidence, canonical Release/Milestone/Dependency facts, read-only review, and automatic derived Attention | C1 accepted; C2 requires a separate authorization | `implementation-packs/IP-029_PHASE_3_EXECUTION_AND_MILESTONE_FOUNDATION.md` | Not created; required in Batch D |
...
4. Decide whether to authorize bounded IP-029 Batch C2 implementation or
   require a C2 design revision. Do not begin D or Phase 4, use a live connector
