...
| IP-030 | Phase 4 fixed seven-dimension Project Health, bounded configuration, and legacy strangler comparison | Design proposed; Batch A unauthorized | `implementation-packs/IP-030_PHASE_4_SEVEN_DIMENSION_PROJECT_HEALTH.md` | Not created; required in Batch D |
...
4. Review IP-030 and approve or revise the Phase 4 design. Do not begin Batch A,
