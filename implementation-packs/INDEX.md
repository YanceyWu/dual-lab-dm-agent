...
| IP-030 | Phase 4 fixed seven-dimension Project Health, bounded configuration, and legacy strangler comparison | Batch A accepted; Batch B requires separate authorization | `implementation-packs/IP-030_PHASE_4_SEVEN_DIMENSION_PROJECT_HEALTH.md` | Not created; required in Batch D |
...
4. Decide whether to authorize bounded IP-030 Batch B or require a design revision. Do not begin Batch B+, use a live connector
