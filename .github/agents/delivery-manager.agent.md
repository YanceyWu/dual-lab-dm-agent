...
scope. Project-health RAG configuration is unavailable in the current Phase 2
interface; never invoke a legacy mapping configuration path or attempt to
confirm a legacy configuration operation. Run
